...
class DebugListenHelloAgentPy(cs.agent.Agent):
    is_agent = True

    def __init__(self, agent_id='debug_listen_hello_agent_py'):
        super().__init__(agent_id)
        self.stream = cs.stream.get_stream(self, "debug_hello_stream_py")
        self.stream2 = cs.stream.create_stream(self, "debug_another_stream_py")
...
if __name__ == '__main__':
    default_sensors_agent = DebugListenHelloAgentPy()
