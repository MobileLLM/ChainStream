...
class StepCounterSocketSensors(BaseSocketSensors):
    is_agent = True

    def __init__(self, agent_id='sys_socket_sensor_sensors_stepcounter', ip='192.168.43.1', port=6666):
        super().__init__(agent_id, stream_name="socket_sensor_stepcounter", ip=ip, port=port)
        # TODO: add sensor data type
        self.cmd = f"sensors,stepcounter"
        pass
...
if __name__ == '__main__':
    ip = '192.168.43.41'
    default_sensors_agent = StepCounterSocketSensors(ip=ip)
