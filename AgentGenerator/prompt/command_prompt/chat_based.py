...
```json
{
    ...
    "message_to_user": "string - Your feedback message to the user explaining what was done (MUST be in Chinese/中文)"
}
```
...
4. The `message_to_user` field MUST be written in Chinese (中文), explaining the changes made in a user-friendly way.
