...
class FewShotEvaluator(SandboxBatchInterface):
    ...
    def get_agent_for_specific_task(self, task):
        generator = ChainStreamFewShotGenerator(base_prompt_example_select_policy="llm", framework_example_number=3)
...
if __name__ == '__main__':
    ...
    evaluator = FewShotEvaluator(task_list, task_log_path="/Users/liou/project/llm/ChainStream/ChainStreamSandBox/batch_simulation_scripts/result/2024-09-05_22-54-27_chainstream_fewshot_3shot_llm/test_log.json")
    evaluator.start()
