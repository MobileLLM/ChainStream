...
class EvalFeedbackGuidedGeneratorForRealTaskWithExample(SandboxBatchInterface):
    ...
    def get_agent_for_specific_task(self, task, verbose=True, only_print_last=True):
        generator = ChainstreamFeedbackGuidedGeneratorForRealTaskWithExample(task_name_now=task.__class__.__name__, max_loop=10, only_print_last=only_print_last, framework_example_number=0, feedback_example_number=1)
...
if __name__ == '__main__':
    ...
    evaluator = EvalFeedbackGuidedGeneratorForRealTaskWithExample(task_list, task_log_path="/Users/liou/project/llm/ChainStream/ChainStreamSandBox/batch_simulation_scripts/result/2024-09-02_02-51-35_chainstream_feedback_0shot_1example_after_debugging/test_log.json")
    evaluator.start()
