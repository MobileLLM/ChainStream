...
class FewShotEvaluator(SandboxBatchInterface):
    ...
    def get_agent_for_specific_task(self, task):
        generator = ChainStreamFewShotGenerator(framework_example_number=2, base_prompt_example_select_policy='llm')
...
if __name__ == '__main__':
    ...
    evaluator = FewShotEvaluator(task_list, task_log_path="/Users/liou/project/llm/ChainStream/ChainStreamSandBox/batch_simulation_scripts/result/2024-09-05_22-54-19_chainstream_fewshot_2shot_llm/test_log.json")
    evaluator.start()
