...
if __name__ == '__main__':
    ...
    evaluator = EvalFeedbackGuidedGeneratorForRealTaskWithExample(task_list, task_log_path="/Users/liou/project/llm/ChainStream/ChainStreamSandBox/batch_simulation_scripts/result/2024-09-05_05-41-40_chainstream_feedback_0example_without_output/test_log.json")
    evaluator.start()
