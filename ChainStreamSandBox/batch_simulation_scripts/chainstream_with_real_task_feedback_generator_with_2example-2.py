...
if __name__ == '__main__':
    ...
    evaluator = EvalFeedbackGuidedGeneratorForRealTaskWithExample(task_list, task_log_path="/Users/liou/project/llm/ChainStream/ChainStreamSandBox/batch_simulation_scripts/result/2024-09-04_14-25-55_chainstream_feedback_0shot_2llm_new-3/test_log.json")
    evaluator.start()
