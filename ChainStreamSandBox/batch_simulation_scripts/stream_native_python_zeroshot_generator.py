...
if __name__ == '__main__':
    ...
    evaluator = StreamNativePythonZeroshotGeneratorBatch(task_list, task_log_path="/Users/liou/project/llm/ChainStream/ChainStreamSandBox/batch_simulation_scripts/result/2024-09-01_15-07-01_native_python/test_log.json")
    evaluator.start()
