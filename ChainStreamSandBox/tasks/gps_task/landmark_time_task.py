...
class LandmarkTimeConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_landmarks' and process the values corresponding to the 'YearBuilt' key in the landmark dictionary: "
            "Add the time when the landmark was bulit to the output stream 'cs_landmarks'."
        )
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_landmark(landmark):
                    ...
                    self.output_stream.add_item(YearBuilt)
