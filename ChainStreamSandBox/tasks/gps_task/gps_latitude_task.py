...
class GPSLatitudeConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_gps' and process the values corresponding to the 'CapitalLatitude' key in the gps dictionary: "
            "Add the gps latitude of the capital to the output stream 'cs_gps'."
        )
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_gps(gps):
                    ...
                    self.output_stream.add_item(gps_latitude)
