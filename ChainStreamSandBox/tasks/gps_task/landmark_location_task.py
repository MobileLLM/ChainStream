...
class LandmarkLocationConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_landmarks' and process the values corresponding to the 'Location' key in the landmark dictionary: "
            "Add the location information to the output stream 'cs_landmarks'."
        )
