...
class NewsTask7(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A stream of the category of the specific news",
                "fields": {
                    "headline": "The headline of the news, string",
                    "category": "The category of the news, string"
                }
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.create_stream(self,"news_category")
    ...
    def init_output_stream(self, runtime):
        self.output_news_stream = cs.stream.get_stream(self, 'news_category')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}
