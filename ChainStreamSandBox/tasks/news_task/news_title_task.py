...
class NewsTask13(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A stream of the headline of the news",
                "fields": {
                    "headline": "The headline of the news, string"
                }
            }
...
class testAgent(cs.agent.Agent):
    ...
    def init_environment(self, runtime):
        ...
        self.output_news_stream = cs.stream.create_stream(self, 'news_title')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}

        def record_output(data):
            self.output_record['news_title'].append(data)
    ...
    def init_output_stream(self, runtime):
        self.output_news_stream = cs.stream.get_stream(self, 'news_title')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}
