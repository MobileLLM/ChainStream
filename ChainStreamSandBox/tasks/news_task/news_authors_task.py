...
class NewsAuthorsConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_news' and process the values corresponding to the 'headline' and 'authors' keys in the news dictionary: "
            "Add the news headline followed by the authors to the output stream 'cs_news'."
        )
