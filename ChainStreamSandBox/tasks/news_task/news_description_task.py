...
class NewsTask9(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A stream of the short description of the news",
                "fields": {
                    "headline": "The headline of the news, string",
                    "short_description": "The short description of the news, string"
                }
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.create_stream(self,"news_description")
    ...
    def start(self):
        def process_news(news):
            ...
            "description": news_short_description})
    ...
    def init_environment(self, runtime):
        ...
        self.output_news_stream = cs.stream.create_stream(self, 'news_description')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}

        def record_output(data):
            self.output_record['news_description'].append(data)
    ...
    def init_output_stream(self, runtime):
        self.output_news_stream = cs.stream.get_stream(self, 'news_description')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}
