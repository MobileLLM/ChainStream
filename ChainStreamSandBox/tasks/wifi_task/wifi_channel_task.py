...
class WifiChannelConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            ...
            "'Channel' key in the wifi dictionary: Add the channel information to the output stream "
            "'cs_wifi'. "
        )
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_wifi(wifi):
                    ...
                    self.output_stream.add_item(Channel)
