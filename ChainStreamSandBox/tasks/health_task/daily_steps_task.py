...
class DailyStepsConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_health' and process the values corresponding to the 'Daily "
            "Steps' key in the health dictionary: "
            "Add the daily steps number to the output stream 'cs_health'."
        )
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_health(health):
                    ...
                    self.output_stream.add_item(Daily_Steps)
