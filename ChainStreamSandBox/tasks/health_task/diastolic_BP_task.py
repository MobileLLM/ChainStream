...
class DiastolicBPConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            ...
            "'DiastolicBP' key in the health dictionary: "
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_health(health):
                    ...
                    self.output_stream.add_item(DiastolicBP)
