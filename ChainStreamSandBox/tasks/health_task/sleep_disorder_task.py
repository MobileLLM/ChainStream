...
class SleepDisorderConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_health' and process the values corresponding to the 'Sleep "
            "Disorder' key in the health dictionary: "
            "Add the sleep disorder type to the output stream 'cs_health'."
        )
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_health(health):
                    ...
                    self.output_stream.add_item(Sleep_Disorder)
