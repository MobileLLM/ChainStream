...
class SleepDurationConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            ...
            "Duration' key in the health dictionary: "
            "Add the sleep duration number to the output stream 'cs_health'."
        )
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_health(health):
                    ...
                    self.output_stream.add_item(Sleep_Duration)
