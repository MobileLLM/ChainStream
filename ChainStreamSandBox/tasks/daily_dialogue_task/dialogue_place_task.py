...
class DialogueTask3(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.create_stream(self,"dialogues_place")
    ...
    def init_environment(self, runtime):
        ...
        def record_output(data):
            self.output_record['dialogues_place'].append(data)
    ...
    def init_output_stream(self, runtime):
        self.output_dialogue_stream = cs.stream.get_stream(self, 'dialogues_place')
