...
class DialoguePlaceConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            ...
            "Identify the location or setting where the dialogue takes place using an LLM."
            "Add the dialogue ID followed by the identified location or setting to the output stream 'cs_dialogues'."
        )
