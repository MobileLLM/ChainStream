...
class DialogueTask2(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A stream of dialogues record with the analysis of the relationship chosen from ["
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.create_stream(self,"dialogues_identity")
    ...
    def init_environment(self, runtime):
        ...
        def record_output(data):
            self.output_record['dialogues_identity'].append(data)
    ...
    def init_output_stream(self, runtime):
        self.output_dialogue_stream = cs.stream.get_stream(self, 'dialogues_identity')
