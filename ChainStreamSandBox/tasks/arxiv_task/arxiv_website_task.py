...
class ArxivWebsiteConfig(SingleAgentTaskConfigBase):
    def __init__(self, paper_number=10):
        ...
        self.task_description = (
            ...
            "Process the value corresponding to the 'license' key in the paper dictionary: "
            "Add the paper's title followed by the license information to the output stream 'cs_arxiv'."
        )
