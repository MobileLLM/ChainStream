...
class ArxivTask4(SingleAgentTaskConfigBase):
...
class testAgent(cs.agent.Agent):
    def __init__(self,agent_id ="test_arxiv_agent"):
        ...
        self.output_stream = cs.create_stream(self, "computer_science_arxiv")
    ...
    def init_output_stream(self, runtime):
        self.output_paper_stream = cs.stream.get_stream(self, 'computer_science_arxiv')
