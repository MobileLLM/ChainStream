...
class TweetTimezoneConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_tweets' and process the values corresponding to the 'user_timezone' key in the tweets dictionary: "
            "Add the timezone of the twitter message to the output stream 'cs_tweets'."
        )
        ...
        class testAgent(cs.agent.Agent):
            ...
            def start(self):
                def process_tweet(tweets):
                    ...
                    self.output_stream.add_item(user_timezone)
