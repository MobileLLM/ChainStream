...
class LandmarkNeighborhoodConfig(SingleAgentTaskConfigBase):
    def __init__(self):
        ...
        self.task_description = (
            "Retrieve data from the input stream 'all_landmarks' and process the values corresponding to the 'Neighborhood' key in the landmark dictionary: "
            "Add the neighborhood property to the output stream 'cs_landmarks'."
        )
