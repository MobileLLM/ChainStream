...
class TweetTask2(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A stream of tweet texts with the name of the twitter users",
                "fields": {
                    "text": "The text of the tweet, string",
                    "name": "The name of the user, string"
                }
...
class testAgent(cs.agent.Agent):
    ...
    def init_output_stream(self, runtime):
        self.output_tweet_stream = cs.stream.get_stream(self, 'tweets_account')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}
