...
class OldGithubTask3(SingleAgentTaskConfigBase):
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A list of the numbers of the github stars",
                "fields": {
                    "name": "the name of the github repository, string",
                    "stars": "the current number of stars of the github repository, int"
                }
            }
        ])
...
class AgentExampleForGithubTask1(cs.agent.Agent):
    def __init__(self, agent_id="agent_example_for_github_task_1"):
        ...
        self.github_output = cs.get_stream(self, "count_github_stars")
