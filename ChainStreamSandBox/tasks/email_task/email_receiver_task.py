...
class EmailTask7(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A stream of emails with the extraction of the receiver",
                "fields": {
                    "Subject": "The subject of the email, string",
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.create_stream(self,"emails_receiver")
    ...
    def init_output_stream(self, runtime):
        self.output_email_stream = cs.stream.get_stream(self, 'emails_receiver')
