        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A stream of emails with the analysis of the emotion chosen from ['positive', "
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.create_stream(self,"emails_emotion")
    ...
    def init_output_stream(self, runtime):
        self.output_email_stream = cs.stream.get_stream(self, 'emails_emotion')
