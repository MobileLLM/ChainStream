...
class AgentExampleForSensorTask6(cs.agent.Agent):
    def __init__(self, agent_id="agent_example_for_weather_task_6"):
        ...
        self.sensor_output = cs.create_stream(self, "alarm_rainfall")
        ...
        def reminder(weather_list):
            for weather in weather_list['item_list']:
                ...
                self.sensor_output.add_item({
                    "Date_Time": date_time,
                    "Precipitation_mm": str(precipitation),
    ...
    def init_output_stream(self, runtime):
        self.output_sensor_stream = cs.stream.get_stream(self, 'alarm_rainfall')
