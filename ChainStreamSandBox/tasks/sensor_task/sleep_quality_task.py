        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                ...
                "description": "A list of the evaluation of the quality of sleep",
                "fields": {
                    "quality_of_sleep": "The evaluation of the quality of sleep, int"}
            }
        ])
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.get_stream(self,"sleep_quality")
    ...
    def init_environment(self, runtime):
        ...
        self.output_health_stream = cs.stream.create_stream(self, 'sleep_quality')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}

        def record_output(data):
            self.output_record['sleep_quality'].append(data)
