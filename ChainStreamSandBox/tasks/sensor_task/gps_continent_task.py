...
class GPSTask8(SingleAgentTaskConfigBase):
    def __init__(self):
        ...
        self.output_stream_description = StreamListDescription(streams=[
            {
                "stream_id": "gps_continent_in_Chinese",
                "description": "A stream of the name of the continents which are translated into Chinese",
                "fields": {
                    "continent_chinese": "The Chinese name of the continent, string"}
            }
        ])
...
class testAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.get_stream(self,"gps_continent_in_Chinese")
    ...
    def init_environment(self, runtime):
        ...
        self.output_gps_stream = cs.stream.create_stream(self, 'gps_continent_in_Chinese')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}

        def record_output(data):
            self.output_record['gps_continent_in_Chinese'].append(data)
    ...
    def init_output_stream(self, runtime):
        self.output_gps_stream = cs.stream.get_stream(self, 'gps_continent_in_Chinese')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}
