...
class ActivityTask1(SingleAgentTaskConfigBase):
    def __init__(self):
        super().__init__()
...
class ActivityDistanceAgent(cs.agent.Agent):
    def __init__(self):
        ...
        self.output_stream = cs.create_stream(self, "distance_over_5k")
    ...
    def init_output_stream(self, runtime):
        self.output_activity_stream = cs.stream.get_stream(self, 'distance_over_5k')
        self.output_record = {x.stream_id: [] for x in self.output_stream_description.streams}
